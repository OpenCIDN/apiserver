...
type SyncStatus struct {
	...
	// Retry is the number of times the sync has been retried.
	Retry int64 `json:"retry,omitempty"`

	// HashSnapshot contains the hash of the resource snapshot being verified.
	HashSnapshot []byte `json:"hashSnapshot"`
